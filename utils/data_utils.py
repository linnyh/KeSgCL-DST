...
def prepare_dataset(data_path, tokenizer, slot_meta,
    ...
    """ # ! 数据处理
    Args:
        data_path (_type_): 数据集路径， json文件
        tokenizer (_type_): _description_
        slot_meta (_type_): _description_
        n_history (_type_): _description_
        max_seq_length (_type_): _description_
        slot_ans (_type_, optional): _description_. Defaults to None.
        diag_level (bool, optional): _description_. Defaults to False.
        op_code (str, optional): _description_. Defaults to '4'.
        op_data_path (_type_, optional): _description_. Defaults to None.
        isfilter (bool, optional): _description_. Defaults to True.
        turn (int, optional): _description_. Defaults to 0.
        if_train (bool, optional): _description_. Defaults to True.
